                     ...
                     //{
                        ...
                        if ($uploadOk == 0) {
                           ...
                           if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
                              ...
                              //$orden = "python2 limpia.py \"'/home/archie/public_html/" . $target_file . "'\" \"'(print-function-list)'\"";
                              $orden = "python3 limpia.py \"'" . $target_file . "'\" \"'(print-function-list)'\"";
                              //echo $orden;
                              //echo "<br>";
