...
;;;Aquí se cargan los archivos de los laberintos.
(load "maze_dir/chico.lisp")
(load "maze_dir/normal.lisp")
(load "maze_dir/forma.lisp")
(load "maze_dir/tall.lisp")
(load "maze_dir/unidos.lisp")
(load "maze_dir/irregular.lisp")
(load "maze_dir/enorme.lisp")
(load "maze_dir/Largo1.lisp")
(load "maze_dir/Largo2.lisp")
(load "maze_dir/Largo3.lisp")
(load "maze_dir/Largo4.lisp")
(load "maze_dir/Pumpkin.lisp")
(load "maze_dir/Diamond.lisp")
(load "maze_dir/Extra.lisp")
;;;Esta es la lista de los laberintos. El orden debe ser exactamente igual al
;;;arreglo de la página laberintos_interfaz.
(defparameter *maze-list* (list 'chico 'normal 'forma 'tall 'unidos 'irregular 'enorme 'Largo1 'Largo2 'Largo3 'Largo4 'Pumpkin 'Diamond 'Extra))
