...
;;;Aquí se cargab los archivos de los laberintos.
(load "maze_dir/maze_1.lisp")
(load "maze_dir/maze_2.lisp")
(load "maze_dir/maze_3.lisp")
(load "maze_dir/maze_4.lisp")
(load "maze_dir/maze_5.lisp")
(load "maze_dir/maze_6.lisp")
(load "maze_dir/Extra_1.lisp")
(load "maze_dir/Extra_2.lisp")
(load "maze_dir/Extra_3.lisp")
(load "maze_dir/Extra_4.lisp")
(load "maze_dir/Extra_5.lisp")
;;;Esta es la lista de los laberintos. El orden debe ser exactamente igual al
;;;arreglo de la página laberinto_interfaz
(defparameter *maze-list* (list 'maze_1 'maze_2 'maze_3 'maze_4 'maze_5 'maze_6 'Extra_1 'Extra_2 'Extra_3 'Extra_4 'Extra_5))
...
;(defparameter *maze-list* (list 'maze_1 'maze_2 'maze_3 'maze_4 'maze_5 'maze_6))
(defun get-maze-data ()
